...
#'
#' Note that `mountainplotyscale.components` is not intended to be called
...
#' \emph{Statistics & Probability Letters}, 81, 1179-1182.
#' https://doi.org/10.1016/j.spl.2011.03.014
#'
#' @examples
#'
...
#'
#' @export
panel.mountainplot <- function(x, type = "s", groups = NULL, ref = TRUE, ...) {
  # junk comment

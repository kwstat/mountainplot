% mountainplot.Rnw
% Time-stamp: <25 Jan 2015 20:23:40 c:/x/rpack/mountainplot/vignettes/mountainplot.Rnw>
...
\title{Introduction to the \textbf{mountainplot} package}
\author{Kevin Wright}
\maketitle
\thispagestyle{fancy}
...
The \code{mountainplot} package provide an extension to the \code{lattice} package
...
Monti (1995) claims that a mountain plot facilitates the following tasks when
exploring data:
\begin{enumerate}
